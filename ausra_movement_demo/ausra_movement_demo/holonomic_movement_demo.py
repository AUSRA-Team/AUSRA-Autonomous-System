...
class HolonomicMovementDemo(Node):
    ...
    def __init__(self):
        ...
        # Startup delay (wait for simulation to stabilize)
        self.startup_delay = 30  # 3 seconds at 10Hz
        self.startup_counter = 0

        self.get_logger().info('Holonomic Movement Demo initialized')
        self.get_logger().info('Waiting for odometry and simulation to stabilize...')
