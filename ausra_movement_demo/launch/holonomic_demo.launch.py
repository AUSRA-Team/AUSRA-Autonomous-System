...
def generate_launch_description():
    ...
    startup_delay_arg = DeclareLaunchArgument(
        'startup_delay_secs',
        default_value='1.0',
        description='Startup delay in seconds for systems to stabilize (1.0s for real hardware, 3.0s for sim)'
    )
    ...
    holonomic_demo_node = Node(
        ...
        parameters=[{
            ...
            'startup_delay_secs': LaunchConfiguration('startup_delay_secs'),
        }]
    )
